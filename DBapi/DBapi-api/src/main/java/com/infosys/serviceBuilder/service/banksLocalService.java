...
public interface banksLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.infosys.serviceBuilder.service.impl.banksLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the banks local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link banksLocalServiceUtil} if injection and service tracking are not available.
	 */

...
/**
 * Provides the local service interface for staff_roster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see staff_rosterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface staff_rosterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.infosys.serviceBuilder.service.impl.staff_rosterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the staff_roster local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link staff_rosterLocalServiceUtil} if injection and service tracking are not available.
	 */
